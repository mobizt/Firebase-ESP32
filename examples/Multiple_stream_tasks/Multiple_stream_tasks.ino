...
void loop()
{
  ...
  if (millis() - sendPrevMillis > 30000)
  {
    ...
    for (int i = 0; i < 3; i++)
    {
      ...
      json1.addString("ID","Node 1").addInt("Count",sendCount + 1).addDouble("Temp", randomDouble(25.0, 40.0));
      json2.addString("ID","Node 2").addInt("Count",sendCount + 1).addDouble("Temp", randomDouble(25.0, 40.0));
